...
const tabs = [
    {
        label: "For you",
        content: (
            <div className=" border border-b-0 m-3 rounded-2xl pt-5 md:pt-6 mx-0 md:mx-auto xl1450:mx-3 md900:mx-2 ">
                <PostPreview />
                <PostPreview />
                <PostPreview />
            </div>
...
export default function Explore() {
    ...
    return (
        <div className=" relative flex items-start justify-between w-full bg-green-20 min-h-screen mb-16 ">
            <div className=" md800:w-full bg-blue-20 md900:w-8/12 xl1450:w-9/12 bg-blue-30 xl1450:mx-0 md800:mx-0 w-ful xl1450:p-12 xl1450:z-40 md900:p-0 md800:ml-0 md900:-ml-5 xl1450:-ml-8  r-0 flex flex-col justify-start items-start relative">
                <div className="  flex flex-col justify-center items-start py-2 md900:relative fixed   xs320:bg-lightGray md900:bg-white w-full z-40">
                    {/* <div className=" hidden md900:flex text-3xl md:text-4xl font-semibold px-3 md:pl-10 mb-5 mt-2 "> */}
                    <div className=" mx-3 w-full bg-green-200 z-50 relative">
                        <input
                            placeholder="Search"
