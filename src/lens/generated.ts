...
export type AllPublicationsTagsQueryVariables = Exact<{
    request: AllPublicationsTagsRequest
}>

export type AllPublicationsTagsQuery = {
    __typename?: "Query"
    allPublicationsTags: {
        __typename?: "PaginatedAllPublicationsTagsResult"
...
export type AllProfilesQueryResult = Apollo.QueryResult<
    ...
    AllProfilesQueryVariables
>
export const AllPublicationsTagsDocument = gql`
...
/**
 * __useAllPublicationsTagsQuery__
 *
 * To run a query within a React component, call `useAllPublicationsTagsQuery` and pass it any options that fit your needs.
 * When your component renders, `useAllPublicationsTagsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useAllPublicationsTagsQuery({
 *   variables: {
 *      request: // value for 'request'
 *   },
 * });
 */
export function useAllPublicationsTagsQuery(
    baseOptions: Apollo.QueryHookOptions<
        AllPublicationsTagsQuery,
        AllPublicationsTagsQueryVariables
    >
) {
    const options = { ...defaultOptions, ...baseOptions }
    return Apollo.useQuery<
        AllPublicationsTagsQuery,
        AllPublicationsTagsQueryVariables
    >(AllPublicationsTagsDocument, options)
}
export function useAllPublicationsTagsLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<
        AllPublicationsTagsQuery,
        AllPublicationsTagsQueryVariables
    >
...
export type AllPublicationsTagsQueryHookResult = ReturnType<
    typeof useAllPublicationsTagsQuery
>
export type AllPublicationsTagsLazyQueryHookResult = ReturnType<
    typeof useAllPublicationsTagsLazyQuery
>
export type AllPublicationsTagsQueryResult = Apollo.QueryResult<
    AllPublicationsTagsQuery,
    AllPublicationsTagsQueryVariables
>
...
export function useEnabledModulesLazyQuery(
    ...
    return Apollo.useLazyQuery<
        EnabledModulesQuery,
        EnabledModulesQueryVariables
    >(EnabledModulesDocument, options)
}
...
export function useProfileAddressLazyQuery(
    ...
    return Apollo.useLazyQuery<
        ProfileAddressQuery,
        ProfileAddressQueryVariables
    >(ProfileAddressDocument, options)
}
...
export function useProfileMirrorsLazyQuery(
    ...
    return Apollo.useLazyQuery<
        ProfileMirrorsQuery,
        ProfileMirrorsQueryVariables
    >(ProfileMirrorsDocument, options)
}
...
export function useRelevantPeopleLazyQuery(
    ...
    return Apollo.useLazyQuery<
        RelevantPeopleQuery,
        RelevantPeopleQueryVariables
    >(RelevantPeopleDocument, options)
}
