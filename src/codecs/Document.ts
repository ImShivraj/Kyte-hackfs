...
// xmtp.org/document
//
// This content type is used for a document content represented by a simple string
export const ContentTypeDocument = new ContentTypeId({
...
export class DocumentCodec implements ContentCodec<string> {
