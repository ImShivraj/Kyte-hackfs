...
import { StarBorderOutlined, PersonOutlineOutlined } from "@mui/icons-material"
...
import { POLYGONSCAN_URL, SIGN_WALLET } from "@constants/index"
import {
    FollowModules,
...
const FollowModule: FC<Props> = ({
    ...
    if (
        ...
        parseFloat(followModule?.amount?.value)
    ) {
        hasAmount = false
    } else {
        hasAmount = true
    ...
    //     useCreateFollowTypedDataMutation({
    //         onCompleted: async ({ createFollowTypedData }: any) => {
    ...
    return (
        <div className="p-5">
            ...
            <div className="flex items-center space-x-2">
                <PersonOutlineOutlined className="w-4 h-4 lt-text-gray-500" />
            ...
            <div className="pt-5 space-y-2">
                ...
                <ul className="space-y-1 text-sm lt-text-gray-500">
                    <li className="flex space-x-2 tracking-normal leading-6">
                        <div>•</div>
                        <div>
                            {`You can comment on @${formatHandle(profile?.handle)}
                            's publications`}
                        </div>
                    </li>
                    <li className="flex space-x-2 tracking-normal leading-6">
                        <div>•</div>
                        <div>
                            {`You can collect on @${formatHandle(profile?.handle)}
                            's publications`}
                        </div>
                    </li>
                    <li className="flex space-x-2 tracking-normal leading-6">
                    ...
                    <li className="flex space-x-2 tracking-normal leading-6">
                        <div>•</div>
                        <div>
                            You will have high voting power if you followed
                            multiple times
                        </div>
                    </li>
                    <li className="flex space-x-2 tracking-normal leading-6">
