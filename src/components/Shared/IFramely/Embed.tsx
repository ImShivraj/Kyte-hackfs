          ...
          <div className="flex items-center">
            ...
            <div className="p-5 truncate">
              <div className="space-y-1.5">
                {og.title && <div className="font-bold line-clamp-1 text-black">{og.title}</div>}
                {og.description && <div className="lt-text-gray-500 line-clamp-2 text-black">{og.description}</div>}
                {og.site && (
