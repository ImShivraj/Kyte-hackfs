...
const DashboardLayout = ({ children }: { children: ReactNode }) => {
    ...
    return (
        ...
        <div className=" grid grid-cols-12  relative bg-red-30 bg-blue-30">
            ...
            <div className="z-[10000] fixed bottom-0 w-full md900:hidden block ">
                <BottomNavigation />
            </div>
            <div
                className={clsx(
                    isMessagesPage && " xl1450:col-span-10",
                    // isMessagesPage &&
                    ...
                    " bg-green-400   md850:col-span-2 md900:col-span-1 md1000:col-span-3 md1050:col-span-3  xl1450:col-span-2 md900:w-full col-span-3 bg-pink-30 hidden md850:block "
                )}
            >
                <Sidebar />
            </div>
            <div
                className={clsx(
                    isMessagesPage && " w-full col-span-12",
                    // isMessagesPage
