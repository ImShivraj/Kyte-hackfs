...
export const Input = forwardRef<HTMLInputElement, Props>(function Input(
    ...
    const iconStyles = [
        ...
        { "[&>*]:peer-focus:text-text_gradient1": variant === "brand" },
        { "[&>*]:peer-focus:text-communityheading": variant !== "brand" },
    ]
            ...
            <div className="flex">
                ...
                <div
                    className={clsx(
                        ...
                        { "rounded-xl": !prefix },
                        {
                            "focus-within:border-text_gradient1 focus-within:ring-text_gradient1":
                                variant === "brand",
                        },
                        {
                            "focus-within:border-communityheading focus-within:ring-communityheading":
                                variant !== "brand",
                        },
                        {
                            "opacity-60 bg-gray-500 bg-opacity-20":
                                props.disabled,
                        },
                        `flex items-center rounded-xl bg-bgDropDown oveflow-hidden duration-500 border border-black border-opacity-5 w-full`
                    )}
