...
const DashboardLayout = ({ children }: { children: ReactNode }) => {
    ...
    return (
        ...
        <div className=" grid grid-cols-12 relative bg-red-30">
            <div className="xl1450:col-span-2  md900:w-16 col-span-3 bg-pink-30 hidden md850:block ">
                <Sidebar />
            </div>
            <div className=" transition ease-in-out active:scale-95 z-50 fixed bottom-24 right-5 w-auto md850:hidden block ">
